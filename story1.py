...
def story():
    location1 = getWord("Enter a Town: ")
    ...
    noun4 = getWord("Enter a Plural Noun: ")
    action2 = getWord("Enter a Action ending in ed: ")
    ...
    text += " At that moment all of the people fighting stop and looked at him."
    text += " Kasu looks at the monster, then at Elijah and makes his " + adjective3
    text += """ face. Kasu says, "Lets team up and kill him for trying to make dumb views off of us fighting. He is going to only get like 300 anyways."""
    text += " So they all teamed up like a bunch of " + noun4
    text += " and " + action2
    text += " him with a golden pated " + object2
    text += ". And he then bled to death on the spot, and they took his stuff."
